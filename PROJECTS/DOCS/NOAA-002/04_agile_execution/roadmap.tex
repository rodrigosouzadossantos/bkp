...
\chapter{Product Roadmap}\label{product-roadmap}

\begin{itemize}
\tightlist
\item
  \textbf{Q1:} Core Engine \& Kafka Integration.
\item
  \textbf{Q2:} Optimization for Edge Devices (Quantization).
\item
  \textbf{Q3:} Advanced Visualization and NLP-based filtering.
\end{itemize}
