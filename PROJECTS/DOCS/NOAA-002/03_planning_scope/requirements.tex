...
\chapter{Requirements Documentation}\label{requirements-documentation}
...
\tightlist
\item
  The system shall support asynchronous inference.
\item
  The system shall integrate with Redis Streams for real-time ETL.
\end{enumerate}
...
\item
  Model weight loading must happen in \textless{} 5 seconds.
\end{enumerate}
