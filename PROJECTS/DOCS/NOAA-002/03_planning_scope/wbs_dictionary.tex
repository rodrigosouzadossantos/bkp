...
\chapter{WBS Dictionary}\label{wbs-dictionary}

\subsection{WP 1.1: Kafka Connect}\label{wp-1.1-kafka-connect}

\begin{itemize}
\tightlist
\item
  \textbf{Owner:} Data Engineer
\item
  \textbf{Description:} Implement the consumer group logic for raw image
  ingestion.
\item
  \textbf{Acceptance Criteria:} Successfully consume 500 images/sec.
\end{itemize}
