...
\chapter{Value Stream Mapping}\label{value-stream-mapping}
...
\tightlist
\item
  \textbf{Ingestion (Kafka/Redis):} Enables real-time responsiveness.
\item
  \textbf{Preprocessing:} Reduces noise, increasing safety accuracy.
\item
  \textbf{Inference (PyTorch/TF):} The core value-add.
\end{enumerate}
