...
\chapter{OKR Dashboard}\label{okr-dashboard}

\textbf{Objective:} Establish the industry-leading CV engine for
industrial safety.
...
\bottomrule\noalign{}
\endlastfoot
KR1: Latency per frame & \textless{} 30ms & 45ms & 🟡 \\
KR2: Test Coverage & \textgreater{} 90\% & 82\% & 🟢 \\
KR3: Model Accuracy (mAP) & \textgreater{} 0.95 & 0.89 & 🟡 \\
\end{longtable}
}
