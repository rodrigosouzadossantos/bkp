...
\chapter{Project Master Dashboard}\label{project-master-dashboard}

Welcome to the governance portal for \textbf{NOAA}. This site serves as
the ``Single Source of Truth'' for PMBOK artifacts and Agile execution.

\subsection{Project Identity}\label{project-identity}
...
\bottomrule\noalign{}
\endlastfoot
\textbf{Project Name} & NOAA \\
\textbf{Lead Specialist} & Rodrigo Souza dos Santos \\
\textbf{Current Phase} & {Planning} \\
\textbf{Last Audit} & \\
\end{longtable}
}
...
\subsection{Artifact Status}\label{artifact-status}

Navigate through the sidebar to access the required PMBOK and Agile
documents.

The \textbf{Project Charter} has been formally authorized. We are
currently decomposing the \textbf{WBS} into the \textbf{Product Backlog}
for Sprint 01.
