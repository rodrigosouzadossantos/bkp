...
class RasterInspector:
    ...
    def get_geotransform_info(self) -> dict[str, Any]:
        ...
        # FIX: handle missing geotransform (JPEG case)
        if gt is None:
            return {
    ...
    def pixel_to_world(
        ...
        # FIX: handle missing geotransform
        if gt is None:
            return 0.0, 0.0
...
if __name__ == "__main__":
    ...
    inspector = RasterInspector(
        spark=spark,
        file_path="FT_20240415_001838_3_BC0030VB0082.tif", #"FT_20241016_062303_6_BC0030VB0153.jpg",
    )
