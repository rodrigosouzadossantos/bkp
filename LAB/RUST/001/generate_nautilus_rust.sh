...
apt update
apt install -y clang llvm-dev libclang-dev cmake build-essential pkg-config libopencv-dev

# Set environment variables for clang-sys and opencv
: "${PKG_CONFIG_PATH:=/usr/lib/pkgconfig:/usr/local/lib/pkgconfig}"
export PKG_CONFIG_PATH
export LLVM_CONFIG_PATH=$(which llvm-config || true)
