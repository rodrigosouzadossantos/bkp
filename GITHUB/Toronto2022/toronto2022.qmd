---
title: "Visibilidade e Governança<br />de Projetos usando GitHub"
...
<center>
<i class="fa-brands fa-github" style="height:120px;vertical-align:middle;"></i>
</center>
...
`Github` plataforma corporativa de colaboração e gestão de projetos  

* Demandas e atividades centralizadas
* Acompanhamento em tempo real
* Rastreabilidade e histórico
* Apoio à governança e decisões
...
## O que é o GitHub
::: {.callout-note}
**Plataforma corporativa de colaboração e gestão de projetos**
:::
...
::: {.callout-tip}
**Uma plataforma para gestão e colaboração**
:::

::: columns
::: column
📌 Organização de demandas e projetos  
📌 Integra planejamento e execução  
:::
